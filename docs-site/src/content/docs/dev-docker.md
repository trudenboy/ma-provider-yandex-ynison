...
# Yandex Music Connect (Ynison) — локальная разработка через Docker

Запусти полноценный Music Assistant с провайдером Yandex Music Connect (Ynison) одной командой —
...
## Подключение провайдера Yandex Music Connect (Ynison)

После входа:

1. Перейди в **Settings** → **Providers**
2. Найди **Yandex Music Connect (Ynison)** в списке — он уже доступен, код загружен автоматически
