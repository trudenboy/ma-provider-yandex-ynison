...
# Yandex Music Connect (Ynison) — Управление инцидентами

## Куда заводить инциденты

> **Заводи задачи здесь:** [github.com/trudenboy/ma-provider-yandex-ynison/issues](https://github.com/trudenboy/ma-provider-yandex-ynison/issues)
...
- **Поле Provider**: устанавливается автоматически для Yandex Music Connect (Ynison)
