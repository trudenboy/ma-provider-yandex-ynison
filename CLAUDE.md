...
This file aligns development of the **Yandex Music Connect (Ynison)** provider with the
...
provider (someone editing `music_assistant/providers/yandex_ynison/` directly in
...
`music_assistant/providers/yandex_ynison` upstream eventually — that is the
